...
from app.api.routes.template_matching import router as template_matching_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(template_matching_router)
    application.include_router(extractions_router)
